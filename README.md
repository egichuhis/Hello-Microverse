...
**Hello Microverse Project** is a simple project to learn and test my knowledge in GitHub flow and Linters.
...
```sh
  cd my-folder
  git clone https://github.com/egichuhis/Hello-Microverse.git
```
...
Feel free to check the [issues page](https://github.com/egichuhis/Hello-Microverse/issues).
